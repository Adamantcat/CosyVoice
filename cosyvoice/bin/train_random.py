...
def main():
    ...
    cv_dataset, cv_data_loader = reinit_dataset_and_dataloader(args.cv_data, args, configs, gan)
    torch.save(cv_dataset, 'cv_dataset.pt')
    ...
    for epoch in range(start_epoch + 1, info_dict['max_epoch']):
        ...
        for datapoint in train_data_loader:
            print("EPOCH: ", epoch)
            print(datapoint['utts'], datapoint['text'])
